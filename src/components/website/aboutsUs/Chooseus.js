...
function Chooseus() {
    ...
    },
    {
      ...
      textL: "Behind every smart tool is a team of experienced specialists ready to support you.",
    },
    {
      icon: "/images/landingpage/future/maximum.svg",
      heading: "Transparent Process",
      textL: "No hidden fees, no surprises — just clear steps and real-time updates.",
    },
    {
                  ...
                  {futureDetail.map((item, index) => (
                    ...
                    >
                      <Box
                        ...
                        src={item.icon}
                        alt={item.heading}
                        sx={{ width:{ xs:38, sm:44 }, height: { xs:38, sm:44 }}}
                      />
                      <Box>
                        <Typography
                          sx={{
